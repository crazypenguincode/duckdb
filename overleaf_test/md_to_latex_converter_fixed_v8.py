...
# -*- coding: utf-8 -*-
"""
Markdown到LaTeX转换脚本 - 图片优化版本v8
基于v7版本，优化图片尺寸设置，避免大图片占整页问题
- 减小图片宽度：流程图75%，对比图70%，普通图65%
- 优化浮动体参数，促进文图混排
- 手动图片宽度调整为60%
"""
    ...
    def generate_conversion_report(self):
        ...
        report = {
            ...
            "version_info": {
                "version": "v8 - 图片优化版本",
                "improvements": {
                    "image_sizing": "优化图片尺寸设置，避免大图片占整页：流程图75%，对比图70%，普通图65%",
                    "float_parameters": "优化LaTeX浮动体参数，促进文图混排，减少单独浮动页",
                    "manual_images": "手动图片宽度调整为60%，更适合文档排版",
                    "text_image_balance": "增加页面文本最小比例到20%，确保图片上下有足够文字填充"
                }
            },
            "detailed_statistics": {
...
"""
    ...
    def run(self):
        """运行完整的转换流程"""
        print("开始Markdown到LaTeX转换 (v8 - 图片优化版本)...")
        print("基于v7版本，优化图片尺寸设置，避免大图片占整页问题")
        ...
        # 使用建议
        print("\n📋 v8图片优化版本说明:")
        print("✅ 图片尺寸: 优化图片宽度设置，流程图75%，对比图70%，普通图65%")
        print("✅ 浮动体优化: 调整LaTeX浮动体参数，促进文图混排")
        print("✅ 手动图片: 手动图片宽度调整为60%，更适合文档排版")
        print("✅ 文字保证: 页面文本最小比例提升到20%，确保图片上下有文字")
        print("✅ 排版改善: 避免大图片占整页，实现更好的文图平衡")
