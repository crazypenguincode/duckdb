...
struct EnableQueryCacheSetting {
    using RETURN_TYPE = bool;
    static constexpr const char *Name = "enable_query_cache";
    static constexpr const char *Description = "Enable query result caching to improve performance of repeated queries";
    static constexpr const char *InputType = "BOOLEAN";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
...
struct QueryCacheMaxSizeSetting {
    using RETURN_TYPE = string;
    static constexpr const char *Name = "query_cache_max_size";
    static constexpr const char *Description = "Maximum size of the query cache (e.g., '100MB', '1GB')";
    static constexpr const char *InputType = "VARCHAR";
    static void SetLocal(ClientContext &context, const Value &parameter);
    static void ResetLocal(ClientContext &context);
    static Value GetSetting(const ClientContext &context);
